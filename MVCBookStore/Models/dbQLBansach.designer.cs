...
namespace MvcBookStore.Models
{
	...
	public partial class VIETSACH : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<SACH1> _SACH1;
    ...
    partial void OnVitriChanged();
		...
		public VIETSACH()
		{
			...
			this._SACH1 = default(EntityRef<SACH1>);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SACH1_VIETSACH", Storage="_SACH1", ThisKey="Masach", OtherKey="Masach", IsForeignKey=true)]
		public SACH1 SACH1
		{
			get
			{
			...
			set
			{
				SACH1 previousValue = this._SACH1.Entity;
				if (((previousValue != value) 
    ...
    partial void OnDongiaChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SACH1_CHITIETDONTHANG", Storage="_SACH1", ThisKey="Masach", OtherKey="Masach", IsForeignKey=true)]
		public SACH1 SACH1
		{
			get
			{
    ...
    partial void OnTenChuDeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CHUDE_SACH1", Storage="_SACH1s", ThisKey="MaCD", OtherKey="MaCD")]
    ...
    partial void OnDienThoaiChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NHAXUATBAN_SACH1", Storage="_SACH1s", ThisKey="MaNXB", OtherKey="MaNXB")]
		public EntitySet<SACH1> SACH1s
		{
			get
			{
    ...
    partial void OnMaNXBChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SACH1_VIETSACH", Storage="_VIETSACHes", ThisKey="Masach", OtherKey="Masach")]
		public EntitySet<VIETSACH> VIETSACHes
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SACH1_CHITIETDONTHANG", Storage="_CHITIETDONTHANGs", ThisKey="Masach", OtherKey="Masach")]
		public EntitySet<CHITIETDONTHANG> CHITIETDONTHANGs
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CHUDE_SACH1", Storage="_CHUDE", ThisKey="MaCD", OtherKey="MaCD", IsForeignKey=true)]
		public CHUDE CHUDE
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NHAXUATBAN_SACH1", Storage="_NHAXUATBAN", ThisKey="MaNXB", OtherKey="MaNXB", IsForeignKey=true)]
		public NHAXUATBAN NHAXUATBAN
		{
			get
			{
